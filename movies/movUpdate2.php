...
<head>
    ...
    <div class="pageInfo">
        ...
        <form action="movUpdate3.php" method="post">
            ...
            <input type="text"   name="movNameField"  value="<?php echo $movName;?>"><br>
            <input type="text"   name="movTypeField"  value="<?php echo $movType;  ?> "><br>
            <input type="text"   name="movGenreField" value="<?php echo $movGenre;  ?> "><br>
            <input type="text"   name="movLengthField"  value="<?php echo $movLength;  ?> "><br>
            <input type="text"   name="movReviewField" value="<?php echo $movReview;  ?> "><br>
            <input type="text"   name="movSummaryField" value="<?php echo $movSummary;  ?> "><br>
